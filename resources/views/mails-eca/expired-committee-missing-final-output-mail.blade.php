...
<body>
    <div class="container" style="text-align: left; display: table; width:100%; vertical-align: middle">
        <div class="content" style="text-align: left;background-size: 100%;display:block;border-radius: 6px;border-width: 6px 1px 1px;border-style: solid;border-color: #025C89 rgb(236, 236, 236) rgb(236, 236, 236);border-image: initial;padding: 25px 0px;margin: 0;box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px;">
            ...
            @if ($languageId == config('languages.en'))
                <div class="ltr-content padding-15"
                    ...
                    <p>
                        The Chairman of the Committee {{ $committeeHeadNameEn }} did not upload the final output of the
