    ...
    <div class="container" style="text-align: left; display: table; width:100%; vertical-align: middle">
        <div class="content"
            ...
            <div class="rtl-content padding-15"
                ...
                <p>
                     لقد تم تغيير حالة المهمة {{$serial_number}} الى {{$taskStatusNameAr}} 
                </p>
                <p>
                    بواسطة {{$changedByNameAr ? $changedByNameAr: $changedByNameEn}}
                </p>
            ...
            <div class="ltr-content padding-15"
                ...
                <p>
                    Task {{$serial_number}} has been changed to {{$taskStatusNameEn}} 
                </p>
                <p>
                    by {{$changedByNameEn ? $changedByNameEn: $changedByNameAr}}
                </p>
