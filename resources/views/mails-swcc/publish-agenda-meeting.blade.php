...
<html>
    <head>
        <title>Meeting Agenda Publish</title>
    ...
    <div class="container" style="text-align: left; display: table; width:100%; vertical-align: middle">
        <div class="content"
            ...
            <div class="rtl-content padding-15"
                ...
                <p>
                    لقد تم نشر جدول الأعمال للإجتماع تحت عنوان {{$titleAr? $titleAr : $titleEn}}
                </p>
                <p>
            ...
            <div class="ltr-content padding-15"
                ...
                <p>
                 Meeting agenda items of meeting {{$titleEn? $titleEn : $titleAr}} have been published 
                </p>
                <p>
