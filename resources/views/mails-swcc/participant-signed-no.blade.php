...
<html>
    <head>
        <title>Meeting MOM Participant Signature</title>
    ...
    <div class="container" style="text-align: left; display: table; width:100%; vertical-align: middle">
        <div class="content"
            ...
            <div class="rtl-content padding-15"
                ...
                <p>
                    لقد رفض العضو  {{$participantNameAr}}  التوقيع على محضر اجتماع  {{$titleAr? $titleAr : $titleEn}} 
                </p>
                @if ($comment)
            ...
            <div class="ltr-content padding-15"
                ...
                <p>
                 Participant {{$participantNameEn}} has refused to sign on meeting  {{$titleEn? $titleEn : $titleAr}}  minutes of meeting
                </p>
                @if ($comment)
                <b style="font-weight: 800;">
                 Comment:
