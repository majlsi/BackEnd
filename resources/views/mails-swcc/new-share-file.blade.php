    ...
    <div class="container" style="text-align: left; display: table; width:100%; vertical-align: middle">
        <div class="content"
            ...
            <div class="rtl-content padding-15"
                ...
                <p>
                لقد تم مشاركه ملف جديد {{$fileNameAr? $fileNameAr : $fileNameEn}} بواسطة {{$createdByNameAr? $createdByNameAr : $createdByNameEn}}
                </p>
                <br>
            ...
            <div class="ltr-content padding-15"
                ...
                <p>
                You have new file has been shared with you {{$fileNameEn? $fileNameEn : $fileNameAr}} by {{$createdByNameEn? $createdByNameEn : $createdByNameAr}}   
                </p>
