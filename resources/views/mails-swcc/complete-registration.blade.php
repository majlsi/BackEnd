...
<html>
    ...
    <body style="margin: 0;padding: 0;width: 100%;color: #333;display: table;font-weight: 100;
       ...
       <div class="container" style="text-align: left; display: table-cell; vertical-align: middle">
            <div class="content" style="text-align: left;background-size: 100%;display: inline-block;border-radius: 6px;border-width: 6px 1px 1px;border-style: solid;border-color: rgb(0, 102, 204) rgb(236, 236, 236) rgb(236, 236, 236);border-image: initial;padding: 25px 0px;margin: 0;box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px;">
                ...
                <div class="rtl-content padding-15"
                    ...
                    <h2 style="font-size: 30px;font-weight: 600;margin-bottom: 20px;">
                        مرحبا بك في المؤسسة العامة لتحلية المياه المالحة!
                    </h2>
                    <p dir="RTL">
                ...
                <div class="ltr-content padding-15" style="padding: 0 30px;text-align: left;direction: ltr;font-weight: 500;font-size: 14px;">
                    ...
                    <h2 style="font-size: 30px;font-weight: 600;margin-bottom: 13px;">Welcome to SWCC</h2>
