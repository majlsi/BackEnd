...
<html>
    ...
    <div class="container" style="text-align: left; display: table-cell; vertical-align: middle">
        <div class="content"
            style="text-align: left;background-size: 100%;display: inline-block;border-radius: 6px;border-width: 6px 1px 1px;border-style: solid;border-color: rgb(0, 102, 204) rgb(236, 236, 236) rgb(236, 236, 236);border-image: initial;padding: 25px 0px;margin: 0;box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px;">
            ...
            <div class="rtl-content padding-15"
                ...
                <p dir="RTL">
                    لقد تلقينا طلبا لاعاده ادخال كلمة المرور الخاصة لحساب مجلسى: {{$email}}.
                    نحن هنا للمساعدة!
                </p>
                <p dir="RTL">
            ...
            <div class="ltr-content padding-15"
                ...
                <p>
                    We received a request to reset your password for your SWCC account: {{$email}}. We're here to help!
                </p>
                <p>
