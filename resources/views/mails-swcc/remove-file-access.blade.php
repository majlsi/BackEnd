...
<html>
    <head>
        <title>Remove file access</title>
    ...
    <div class="container" style="text-align: left; display: table; width:100%; vertical-align: middle">
        <div class="content"
            ...
            <div class="rtl-content padding-15"
                ...
                <p>
                لقد تم إلغاء مشاركه ملف معك{{$fileNameAr? $fileNameAr : $fileNameEn}} بواسطة {{$createdByNameAr? $createdByNameAr : $createdByNameEn}}
                </p>
                <br>
            ...
            <div class="ltr-content padding-15"
                ...
                <p>
                Your access on file has been removed {{$fileNameEn? $fileNameEn : $fileNameAr}} by {{$createdByNameEn? $createdByNameEn : $createdByNameAr}}   
                </p>
