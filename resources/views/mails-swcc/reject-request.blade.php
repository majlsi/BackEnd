...
<head>
    <title>Request has been rejected</title>
        ...
        <div class="content"
            ...
            @if ($languageId == config('languages.ar'))
                <div class="rtl-content padding-15"
                    ...
                    @if ($url)
                        <p>
                            يمكنك متابعة لجانك من خلال الرابط التالى
                        </p>
                        <p>
                    ...
                    <p dir="RTL" style="font-weight: 700;margin-bottom: 10px;">
                        في حالة وجود أي استفسارات ، لا تتردد في الاتصال بنا على Support@SWCC.gov.sa في أي وقت. كنا نحب أن
                        نسمع منك.
                    </p>
                    <p dir="RTL" style="font-weight: 700;margin-bottom: 10px;">
            ...
            @if ($languageId == config('languages.en'))
                <div class="ltr-content padding-15"
                    ...
                    @if ($url)
                        <p>
                            You can follow committees through the following link.
                        </p>
                        <p>
                    ...
                    <p style="font-weight: 700;margin-bottom: 10px;">
                        In case you have any inquiries , don’t hesitate to contact us at Support@SWCC.gov.sa any time. We
