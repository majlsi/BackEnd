...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
  ...
  <title>Saudi General Authority of Foreign Trade - PDF</title>

  <!-- Custom styles for this template -->
  <link rel="stylesheet"  type="text/css" media="all" href="{{ asset('css/gaft/PDF.css') }}" >
...
<body>
      <div class="imagelogo" style="display: block;position: absolute;right: 40px;">
          <img style="max-height:2em!important;max-width:6em;border-radius: 50%;" src="{{ $data['meeting_mom_template_logo'] }}">
        </div>
  ...
  <!-- Page Template -->
  <div class="white-page mx-auto" style="margin-top:100px">
  ...
  <!-- @if($data['show_mom_header'] == 1)
    ...
    {!! $data["introduction_template_en"] !!}
     ...
     @if(count($data['meeting_participants'])) 
       <div class="list-row" style="page-break-inside: avoid;display:inline-block;width:100%;margin-bottom: 2mm;">
         <span style="width:16%;" class="bold">
           <span style="margin: auto;">{!! $data["member_list_introduction_template_en"] !!}</span>
		 </span>
		 <br>
         <span class="font-10" style="width: 80%;">
           <span>
...
@endif
 ...
 <h4 class="section-heading" style="font-weight: 600;font-size: 15pt;line-height: 14pt;margin: 6mm 0 3mm;">Conclusion</h4>

{!! $data["conclusion_template_en"] !!}
