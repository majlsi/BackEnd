...
<html>
    <head>
        ...
        <style>
            ...
            .content {
                text-align: left;display: inline-block;border-radius: 6px;border: 1px solid #ececec;padding: 25px 0;margin: 15px;border-top: 6px solid #34607B;box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.16);
            }
    ...
    <body style="margin: 0;padding: 0;width: 100%;color: #333;display: table;font-weight: 100;
       ...
       <div class="container" style="text-align: left; display: table-cell; vertical-align: middle">
            <div class="content" style="text-align: left;background-size: 100%;display: inline-block;border-radius: 6px;border-width: 6px 1px 1px;border-style: solid;border-color: #34607B rgb(236, 236, 236) rgb(236, 236, 236);border-image: initial;padding: 25px 0px;margin: 0;box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px;">
