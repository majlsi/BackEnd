        ...
        <div class="content" style="text-align: left;background-size: 100%;display:block;border-radius: 6px;border-width: 6px 1px 1px;border-style: solid;border-color: rgb(245, 133, 31) rgb(236, 236, 236) rgb(236, 236, 236);border-image: initial;padding: 25px 0px;margin: 0;box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px;">
            ...
            @if ($languageId == config('languages.ar'))
                <div class="rtl-content padding-15"
                    ...
                    <p dir="RTL" style="font-weight: 700;margin-top: 0;"> مسئول الدعم <br> فريق لجاني </p>
                </div>
            @endif
            ...
            @if ($languageId == config('languages.en'))
                <div class="ltr-content padding-15"
                    ...
                    <p style="font-weight: 700;margin-top: 0;"> Customer Support Representative, <br> lijani Team </p>
                </div>
            @endif
        </div>
    </div>
