...
<body>
  ...
  <div class="white-page mx-auto">
    ...
    <div class="" style="page-break-inside: avoid; margin-top:2rem;">
      تم -بعون الله تعالى- انعقاد {{ $data['meeting_title_ar'] }} ل {{ $data['committee_name_ar'] }} بتاريخ
      {{ $data['meeting_schedule_date_from'] }} في تمام الساعة {{ $data['meeting_schedule_time_from'] }}، ب
      ...
      <div class="list-row" style="page-break-inside: avoid;display:inline-block;width:100%;margin-bottom: 2mm;">
        ...
        <span class="font-10" style="width: 80%;">
          <span>
            <span>
              @if (
              $data['meeting_committee']['committee_head']['job_title_ar'] != null &&
              !empty($data['meeting_committee']['committee_head']['job_title_ar']))
              {{ $data['meeting_committee']['committee_head']['job_title_ar'] }}
              @else
              @if (
              $data['meeting_committee']['committee_head']['job_title_en'] != null &&
              !empty($data['meeting_committee']['committee_head']['job_title_en']))
              {{ $data['meeting_committee']['committee_head']['job_title_en'] }}
              @endif
              @endif

              @if (
              $data['meeting_committee']['committee_head']['nickname_ar'] != null &&
              !empty($data['meeting_committee']['committee_head']['nickname_ar']))
              {{ $data['meeting_committee']['committee_head']['nickname_ar'] }}
              @else
              @if (
              $data['meeting_committee']['committee_head']['nickname_en'] != null &&
              !empty($data['meeting_committee']['committee_head']['nickname_en']))
              {{ $data['meeting_committee']['committee_head']['nickname_en'] }}
              @endif
              @endif

              @if (
              $data['meeting_committee']['committee_head']['user_title_ar'] != null &&
              !empty($data['meeting_committee']['committee_head']['user_title_ar']))
              ...
              @if (
              $data['meeting_committee']['committee_head']['name_ar'] == null ||
              empty($data['meeting_committee']['committee_head']['name_ar']))
    ...
    <div class="bold" style="padding-top:2mm;font-weight: 600;">
      <h4 class="section-heading" style="font-weight: 600;font-size: 15pt;line-height: 14pt;margin: 6mm 0 3mm;">جدول
        اﻷعمال</h4>
        ...
        <div style="text-align:right;">
          <h4 style="font-weight: 600;font-size: 15pt;line-height: 14pt;margin: 3mm 0 5mm;">
            ...
            <span style="font-weight: 500;font-size: 11pt;line-height: 14pt;margin: 2mm 0 4mm;">
              (دقيقة {{ $agenda['agenda_time_in_min'] }})
            </span>
            @endif
          </h4>
        </div>
        ...
        <div class="m-demo mb-2" style="border-top: 1px dashed #ddd;margin: 1mm 0 5mm;padding: 2mm 0 0;">
          <div class="m-demo__preview--btn"><!--class="m-demo__preview"-->
            ...
            <p class="mt-0" style="color: #333;margin: 0;">
              ...
              &nbsp;<span>({{ $agendaVote['vote_result_status_name_ar'] ? $agendaVote['vote_result_status_name_ar'] :
                $agendaVote['vote_result_status_name_en'] }})</span>
              @endif
            </p>
