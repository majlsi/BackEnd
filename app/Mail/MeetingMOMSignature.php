...
class MeetingMOMSignature extends Mailable
{
     ...
     * @return void
     */
    public function __construct($nameAr, $nameEn, $titleAr, $titleEn, $meetingId,$languageId)
    {
        $this->nameEn = $nameEn;
        $this->nameAr = $nameAr;
    ...
    public function build()
    {
        ...
        return $this->view($mailFolderName . '.mom-signature')
