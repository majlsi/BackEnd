...
class MicrosoftTeamConfigurationService extends BaseService
{

    public function __construct(DatabaseManager $database, MicrosoftTeamConfigurationRepository $repository)
    {
